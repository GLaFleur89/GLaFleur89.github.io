...
var items = document.getElementsByClassName('mover'); // removed from function to invoke only when needed
...
function updatePositions() {
  ...
  for (var i = 0; i < itemLength; i++) {
    ...
    var xpos = -items[i].basicLeft + 1440 * phase + 'px';
...
// Changed to requestAnimationFrame to reduce paint time and improve animation
